  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-6 lg:mb-8">
        <div>
          <h1 className="text-xl sm:text-2xl lg:text-3xl font-black italic uppercase tracking-tight">Painel Administrativo</h1>
          <p className="text-xs sm:text-sm text-gray-500 mt-1">Gestão completa da Liga de Quebrada • Temporada 2026</p>
        </div>
        <div className="flex items-center gap-2 bg-[#10B981]/10 border border-[#10B981]/20 px-3 py-1.5 sm:px-4 sm:py-2 self-start">
          <div className="w-2 h-2 bg-[#10B981] rounded-full animate-pulse" />
          <span className="text-[10px] sm:text-xs font-bold text-[#10B981] uppercase">Sistema Online</span>
        </div>
      </div>
